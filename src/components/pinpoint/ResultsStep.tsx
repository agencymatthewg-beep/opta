...
export function ResultsStep({ game, goal, recommendations, onStartNew }: ResultsStepProps) {
  ...
  return (
    ...
    >
      {/* Success icon */}
      <motion.div
        className="w-24 h-24 mx-auto mb-6 rounded-2xl glass border border-success/30 flex items-center justify-center"
      ...
      {/* Results summary */}
      <motion.div
        className="glass rounded-xl p-6 mb-6 text-left"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
