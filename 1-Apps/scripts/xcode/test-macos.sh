...
Run macOS tests with deterministic package resolution.

Options:
  --target <name>         Known preset target (default: plus-macos)
...
xcode_prepare_output_paths "test-macos" "${scheme_arg}" "${configuration}"

xcode_info "Testing macOS scheme '${scheme_arg}'"
