...
## Summary
- CEO autonomy run aborted. cycle=1 phase=1 stage=research. tool_calls=0 across 0 tool turns. objective: Working?
...
| autonomy | completion | status | fail | run status: aborted |
