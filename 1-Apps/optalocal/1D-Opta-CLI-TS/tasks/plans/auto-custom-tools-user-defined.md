# Auto Task: Custom tools (user-defined)

## Why now
Competitive gap score is **3** (HIGH). Multiple competitors now ship this capability.

## Objective
Implement **Custom tools (user-defined)** in Opta CLI with production-safe defaults and no regression to current behavior.
