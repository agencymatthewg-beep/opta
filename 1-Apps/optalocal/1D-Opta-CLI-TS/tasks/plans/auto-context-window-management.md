# Auto Task: Context window management

## Why now
Competitive gap score is **3** (HIGH). Multiple competitors now ship this capability.

## Objective
Implement **Context window management** in Opta CLI with production-safe defaults and no regression to current behavior.
