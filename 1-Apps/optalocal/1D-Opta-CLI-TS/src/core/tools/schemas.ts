...
export const TOOL_SCHEMAS = [
  ...
  },
  {
    ...
    function: {
      name: 'browser_open',
      description: 'Open a browser session (isolated or attach mode).',
      parameters: {
        type: 'object',
        properties: {
          session_id: { type: 'string', description: 'Optional explicit browser session ID' },
          mode: { type: 'string', enum: ['isolated', 'attach'], description: 'Browser mode' },
          ws_endpoint: { type: 'string', description: 'CDP WebSocket endpoint for attach mode' },
          headless: { type: 'boolean', description: 'Launch headless browser (default: true)' },
        },
        required: [],
      },
    },
  ...
  },
  {
    ...
    function: {
      name: 'browser_click',
      description: 'Click a selector in an open browser session.',
      parameters: {
        type: 'object',
        properties: {
          session_id: { type: 'string', description: 'Browser session ID' },
          selector: { type: 'string', description: 'CSS selector to click' },
          timeout_ms: { type: 'number', description: 'Action timeout in milliseconds' },
        },
  ...
  },
  {
    ...
    function: {
      name: 'browser_type',
      description: 'Type text into a selector in an open browser session.',
      parameters: {
        type: 'object',
        properties: {
          session_id: { type: 'string', description: 'Browser session ID' },
          selector: { type: 'string', description: 'CSS selector to fill' },
          text: { type: 'string', description: 'Text content to type/fill' },
          timeout_ms: { type: 'number', description: 'Action timeout in milliseconds' },
        },
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Capture HTML snapshot artifact for an open browser session.',
      parameters: {
        type: 'object',
        properties: {
          session_id: { type: 'string', description: 'Browser session ID' },
  ...
  },
  {
    ...
    function: {
      ...
      description: 'Capture screenshot artifact for an open browser session.',
      parameters: {
        type: 'object',
        properties: {
          session_id: { type: 'string', description: 'Browser session ID' },
