...
const ADVANCED_PROFILE_ONLY_KEYS = new Set<string>([
  ...
  'safety.compactAt',
  'safety.maxParallelTools',
  'journal.sessionLogsDir',
  'journal.updateLogsDir',
  'journal.author',
  'journal.timezone',
  'learning.ledgerPath',
  'policy.audit.path',
...
const PAGE_ITEMS: Record<SettingsPageId, SettingsItem[]> = {
  ...
  safety: [
    ...
    { label: 'Sub-Agents',          configKey: 'subAgent.enabled',             defaultValue: 'true',                description: 'Allow AI to spawn recursive sub-agents',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'Max Parallel Tools',  configKey: 'safety.maxParallelTools',      defaultValue: '8',                   description: 'Max concurrent tool executions allowed',                     hint: 'Default: 8' },
  ...
  system: [
    { label: 'Auto Commit',         configKey: 'git.autoCommit',               defaultValue: 'true',                description: 'Automatically commit successful AI changes',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'Journaling',          configKey: 'journal.enabled',              defaultValue: 'true',                description: 'Record session logs and updates',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'Learning Ledger',     configKey: 'learning.enabled',             defaultValue: 'true',                description: 'Write reinforcement learning examples',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'Policy Auditing',     configKey: 'policy.enabled',               defaultValue: 'true',                description: 'Enforce and audit policy boundaries',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'Reports',             configKey: 'reports.enabled',              defaultValue: 'true',                description: 'Generate execution reports',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
  ...
  advanced: [
    ...
    { label: 'Auto-Invoke Browser', configKey: 'browser.autoInvoke',           defaultValue: 'false',               description: 'Automatically start browser if needed',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'Browser Screenshots', configKey: 'browser.screenshotPolicy',     defaultValue: 'on-demand',           description: 'When to capture screenshots',
      inputType: 'select', options: [{ label: 'On Demand', value: 'on-demand'}, { label: 'Always', value: 'always'}, { label: 'Disabled', value: 'disabled'}] },
    ...
    { label: 'BG Computer Control', configKey: 'computerControl.background.enabled', defaultValue: 'true',          description: 'Background computer operations',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
    { label: 'FG Computer Control', configKey: 'computerControl.foreground.enabled', defaultValue: 'false',         description: 'Foreground/screen operations',
      inputType: 'toggle', options: [{ label: 'Enabled', value: 'true'}, { label: 'Disabled', value: 'false'}] },
