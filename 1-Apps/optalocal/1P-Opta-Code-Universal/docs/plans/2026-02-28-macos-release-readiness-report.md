...
Project: `1P-Opta-Code-Universal`
...
- Description: CI path filter was broken (`optalocal/1P-Opta-Code-Universal/**` missing `1-Apps/` prefix) from the 2026-02-28 domain reorg until this commit. The macOS build CI has not been triggered since the reorg.
...
- This report is the initial baseline for the `1P-Opta-Code-Universal` macOS release gate. It will be updated after the first successful CI run.
