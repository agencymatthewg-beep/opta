...
- Description: CI path filter was broken (`optalocal/1P-Opta-Code-Universal/**` missing `1-Apps/` prefix) from the 2026-02-28 domain reorg until this commit. The Windows build CI has not been triggered since the reorg.
