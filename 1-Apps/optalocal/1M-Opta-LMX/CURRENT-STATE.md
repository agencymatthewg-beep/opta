# Opta LMX — Current State (2026-03-04)
...
- **Opta LMX Dashboard** (`1L-Opta-LMX-Dashboard`) scaffolded — Next.js 16 at port 3003
- Domain: `lmx.optalocal.com` (currently frozen legacy deploy, will redeploy from new project)
- Role: primary user-facing management surface (same as Opta Code → Opta CLI)
