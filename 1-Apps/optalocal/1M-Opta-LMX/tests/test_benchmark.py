...
def _make_stats() -> BenchmarkRunStats:
    return BenchmarkRunStats(
        ...
        toks_per_sec_p95=19.5,
        toks_per_sec_mean=19.8,
        prompt_tokens=10,
        output_tokens=50,
        runs_completed=5,
...
async def test_benchmark_run_returns_all_required_fields(mock_engine, tmp_path) -> None:
    from opta_lmx.config import LMXConfig
    from opta_lmx.main import create_app
    from opta_lmx.monitoring.benchmark import BenchmarkResultStore
...
async def test_benchmark_result_persisted_to_disk(mock_engine, tmp_path) -> None:
    from opta_lmx.config import LMXConfig
    from opta_lmx.main import create_app
    from opta_lmx.monitoring.benchmark import BenchmarkResultStore
...
async def test_benchmark_results_endpoint_filters_by_model(mock_engine, tmp_path) -> None:
    from opta_lmx.config import LMXConfig
    from opta_lmx.main import create_app
    from opta_lmx.monitoring.benchmark import BenchmarkResult, BenchmarkResultStore
