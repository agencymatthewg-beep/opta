...
# Remove 'opta local' and divider from the template
template = template.replace('<span class="opta-local">opta local</span>', '')
template = template.replace('<div class="divider"></div>', '')
...
for app_name, info in apps.items():
    ...
    out_html = f'design/logos/Opta-{app_name}/opta-{info["slug"]}-short.html'
    out_png = f'design/logos/Opta-{app_name}/opta-{info["slug"]}-short.png'
...
print("Done rendering short logos.")
