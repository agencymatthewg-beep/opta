...
A statically exported Next.js 16 marketing + onboarding site for the Opta Local stack. It lives at init.optalocal.com. It has exactly one job: get users downloaded, install-ready, and handed off to runtime surfaces as the **Opta Initializer** (short name: **Opta Init**).
