...
> = {
  ...
  'gu-masterclass': {
    id: 'gu-masterclass',
    label: 'Interactive /gu Masterclass',
    explanationExtent: 'L4-masterclass',
    description:
      'Self-contained HTML guide generated by the /gu workflow. All content lives in the HTML file — section validation is bypassed.',
    minSections: 0,
    minWordCount: 0,
    requiresCodeExample: false,
    minVisuals: 0,
    ...
    minRichBlocks: 0,
    requiredFlowStages: [],
    enforceSettingsCoverageOnAppGuides: false,
  },
};
...
export function validateGuideByTemplate(guide: GuideLike): string[] {
  // /gu guides carry all content in the HTML file — skip all section/word/visual checks
  if (guide.format === 'gu') return [];
