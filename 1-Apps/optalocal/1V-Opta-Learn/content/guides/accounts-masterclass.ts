...
export const accountsMasterclass: Guide = {
  ...
  sections: [
    ...
    {
      heading: '[Configuration] Cloud Keychain & Token Rotation',
    ...
    {
      heading: '[Operation] Security Boundaries & Blast Radius Control',
    ...
    {
      heading: '[Troubleshooting] Incident Recovery & Break-Glass Workflow',
    ...
    {
      heading: '[Optimization] Team Rollout Patterns For New Orgs',
