...
- Follow-up: keep Supabase schema checks in `1R-Opta-Accounts/src/app/api/health/supabase/route.ts` aligned with migration cadence so schema drift is caught before deployments.
