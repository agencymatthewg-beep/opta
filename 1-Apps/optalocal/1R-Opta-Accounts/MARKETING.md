...
*   **Terminal-to-Browser Auth:** Brings modern OAuth (Google, Apple) securely to the terminal. Typing `opta account login --oauth` automatically opens your browser, securely authenticates you, and relays the token directly back to your local port without you ever copy-pasting a key.
