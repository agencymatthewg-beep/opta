...
import { signInWithGoogle, signInWithApple, signInWithGithub } from '@/lib/supabase/auth-actions';
...
export function OAuthButtons({ redirectAfter }: OAuthButtonsProps) {
  const [loading, setLoading] = useState<'google' | 'apple' | 'github' | null>(null);
