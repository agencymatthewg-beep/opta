  ...
  return (
    <div className="min-h-screen bg-void text-text-primary font-sans overflow-x-hidden selection:bg-primary/30 selection:text-white">
      ...
      <motion.div
        ...
        className="fixed inset-y-0 left-[8%] w-px bg-gradient-to-b from-primary/50 via-neon-blue/20 to-transparent z-0 hidden md:block pointer-events-none"
      />
      <motion.div
        initial="hidden"
        animate="show"
        variants={lineRevealY}
        className="fixed inset-y-0 right-[8%] w-px bg-gradient-to-b from-primary/50 via-neon-blue/20 to-transparent z-0 hidden md:block pointer-events-none"
      />
      <motion.div
        initial="hidden"
        animate="show"
        variants={lineRevealX}
        className="fixed inset-x-0 top-[12%] h-px bg-gradient-to-r from-transparent via-primary/40 to-transparent z-0 hidden md:block pointer-events-none"
      />
      ...
      <main className="relative z-10 pt-40 pb-32">
        ...
        >
          ...
          <div className="md:col-span-12 mb-20 relative">
            ...
            <h1 className="text-[10vw] leading-[0.9] font-bold tracking-tighter uppercase">
              <div className="overflow-hidden pb-4">
                <motion.div variants={textUp} className="text-moonlight">
                  Deploy
                </motion.div>
              </div>
          ...
          <div className="md:col-span-4 md:col-start-2">
            ...
            >
              The definitive bootstrap for Apple Silicon AI. Run LLMs locally
              with our highly optimized, private inference stack. Zero cloud.
              Pure capability.
            </motion.p>
            ...
            <motion.a
              href="#install"
              variants={textUp}
              className="mt-12 group cursor-pointer inline-flex items-center gap-4 obsidian-interactive p-3 rounded-full pr-8 border border-white/10"
            >
        ...
        >
          <motion.div variants={fadeUp} className="mb-16 text-center">
            <h2 className="text-sm text-primary uppercase tracking-[0.2em] mb-4">
              Command Line Interface
            </h2>
            <h3 className="text-4xl md:text-5xl font-bold text-moonlight">
              Visual Terminal App.
            </h3>
            <p className="mt-6 text-lg text-text-secondary font-light max-w-2xl mx-auto">
              A highly interactive TUI (Terminal User Interface). Navigate with
              menus, switch models, and chat—no complex arguments required.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <motion.div variants={fadeUp} className="flex flex-col">
                ...
                <div className="p-6 font-mono text-xs flex-1 bg-[#0a0a0c] flex flex-col items-center justify-center relative">
                  ...
                  <div className="w-[180px] space-y-1">
                    ...
                    {SHOWCASE_CONTENT.welcome.menuItems.map((item, i) => (
                      <div
                        key={i}
                        className={`flex justify-between px-2 py-1.5 rounded ${i === 0 ? "bg-primary/20 text-primary" : "text-text-secondary"}`}
                      >
              ...
              <div className="mt-6 text-center">
                <h4 className="font-semibold text-text-primary">
                  {SHOWCASE_CONTENT.welcome.heading}
                </h4>
                <p className="text-sm text-text-muted mt-2 leading-relaxed">
                  {SHOWCASE_CONTENT.welcome.caption}
                </p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="flex flex-col">
              <div className="glass-strong rounded-xl border border-white/10 overflow-hidden h-[300px] flex flex-col">
                ...
                <div className="p-6 font-mono text-[11px] flex-1 bg-[#0a0a0c] flex flex-col">
                  <div className="inline-flex items-center gap-1.5 rounded-full border border-primary/20 bg-primary/10 px-2 py-0.5 text-primary self-start mb-6">
                    <span className="w-1.5 h-1.5 rounded-full bg-neon-green shadow-[0_0_5px_#22c55e]" />{" "}
                    {SHOWCASE_CONTENT.chat.model}
                  </div>
                  <div className="space-y-4">
                    {SHOWCASE_CONTENT.chat.messages.map((msg, i) => (
                      <div key={i}>
                        <div
                          className={`mb-1 font-medium ${msg.role === "user" ? "text-neon-blue" : "text-primary"}`}
                        >
                          {msg.role === "user" ? "You" : "Opta"}
                        </div>
                        <div
                          className={`p-3 rounded-lg leading-relaxed ${msg.role === "user" ? "bg-white/5 text-text-primary" : "bg-primary/5 text-text-secondary border border-primary/10"}`}
                        >
                          {msg.text.split("\n").map((line, j) => (
              ...
              <div className="mt-6 text-center">
                <h4 className="font-semibold text-text-primary">
                  {SHOWCASE_CONTENT.chat.heading}
                </h4>
                <p className="text-sm text-text-muted mt-2 leading-relaxed">
                  {SHOWCASE_CONTENT.chat.caption}
                </p>
              </div>
            </motion.div>
            ...
            <motion.div variants={fadeUp} className="flex flex-col">
                  ...
                  <div className="w-full max-w-[220px] rounded-lg border border-white/10 bg-[#141419] p-3 shadow-2xl">
                    ...
                    <div className="space-y-1">
                      {SHOWCASE_CONTENT.menu.items.map((item, i) => (
                        <div
                          key={i}
                          className={`flex items-center gap-2 rounded px-2 py-1.5 ${item.active ? "bg-primary/20 text-primary" : "text-text-secondary"}`}
                        >
                          <div
                            className={`w-1.5 h-1.5 rounded-full ${item.active ? "bg-primary" : "bg-transparent"}`}
                          />
                          {item.label}
                        </div>
                      ))}
              ...
              <div className="mt-6 text-center">
                <h4 className="font-semibold text-text-primary">
                  {SHOWCASE_CONTENT.menu.heading}
                </h4>
                <p className="text-sm text-text-muted mt-2 leading-relaxed">
                  {SHOWCASE_CONTENT.menu.caption}
                </p>
              </div>
            </motion.div>
          </div>
        ...
        >
          <motion.div
            variants={fadeUp}
            className="obsidian rounded-2xl border border-white/10 overflow-hidden relative"
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="p-12 lg:p-16 flex flex-col justify-center relative z-10">
                ...
                <h2 className="text-4xl font-bold mb-6 text-moonlight">
                  One Command.
                  <br />
                  Full Stack.
                </h2>
                <p className="text-text-secondary mb-10 font-light leading-relaxed">
                  Run the initialization script. We handle the Python
                  environments, Node.js dependencies, MLX model pulling, and
                  background daemon registration automatically.
                </p>
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3 text-sm text-text-muted">
                    <CheckCircle2 className="w-4 h-4 text-neon-amber" /> 16GB
                    Unified Memory minimum
                  </div>
                </div>
              </div>
                  ...
                  <div className="p-6 text-sm text-text-secondary space-y-3 relative z-10">
                    ...
                    <div className="pt-4 space-y-1 opacity-70">
                      ...
                      <p className="text-text-muted mt-2">
                        Run `opta tui` to open the dashboard.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        >
          <motion.div variants={fadeUp} className="text-center mb-16">
            ...
            <p className="mt-4 text-text-secondary font-light">
              Prefer manual installation? Grab the PKG files below.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {Object.entries(DOWNLOADS).map(([key, data]) => (
              <motion.div
                key={key}
                variants={fadeUp}
                className="obsidian p-8 rounded-2xl border border-white/10 hover:border-primary/40 transition-colors flex flex-col group"
              >
          ...
          <motion.div variants={fadeUp}>
            <div className="glass-strong border border-white/20 rounded-3xl p-16 text-center relative overflow-hidden group">
              ...
              <div className="relative z-10">
                <h2 className="text-3xl md:text-5xl font-bold mb-6 text-moonlight">
                  Ready to manage your models?
                </h2>
                <p className="text-lg text-text-secondary font-light max-w-xl mx-auto mb-10">
                  Access your Web Dashboard to monitor performance, manage
                  weights, and chat—all in a beautiful browser interface.
                </p>
                <a
                  href={DASHBOARD_URL}
                  className="inline-flex h-14 px-8 items-center justify-center gap-2 rounded-xl bg-white text-void font-bold text-lg hover:bg-white/90 transition-colors shadow-[0_0_30px_rgba(255,255,255,0.2)]"
                >
        ...
        <div className="max-w-7xl mx-auto px-[8%] py-12 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2 text-text-muted">
            ...
            <span className="text-sm font-light">
              Opta Operations © 2026. Secure by design.
            </span>
          </div>
