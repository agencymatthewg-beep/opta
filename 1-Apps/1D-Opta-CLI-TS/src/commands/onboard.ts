...
export async function runOnboarding(): Promise<void> {
  console.log();
  console.log(chalk.bold('  Welcome to Opta CLI!'));
  ...
  if (connected) {
    ...
    if (!connected) {
      console.log(chalk.dim('     You can configure later: opta config set connection.host <ip>'));
      console.log(chalk.dim('     Or set connection.port to match your LMX server'));
    }
  }
