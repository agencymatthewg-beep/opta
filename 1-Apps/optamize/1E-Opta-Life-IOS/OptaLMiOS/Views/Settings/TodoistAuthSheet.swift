...
struct TodoistAuthSheet: View {
    ...
    private var privacySection: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Authentication uses OAuth 2.0. Your access token is stored in the iOS Keychain and may sync to your Opta account if cloud credential sync is enabled.")
                .font(.caption)
