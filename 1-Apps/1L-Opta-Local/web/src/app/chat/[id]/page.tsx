  ...
  return (
    <main className="flex min-h-screen items-center justify-center p-8">
      <motion.div
        ...
        className="glass-subtle max-w-sm rounded-xl p-8 text-center"
      >
...
export default function SessionResumePage() {
  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        // Handled by resume hook error state
      }
    }
  ...
  return (
    <main className="flex flex-col h-screen">
      ...
      <header className="glass border-b border-opta-border px-6 py-3 flex-shrink-0">
        <div className="flex items-center gap-4">
                ...
                <>
                  ...
                  {session.tool_call_count > 0 && (
                    <span className="flex items-center gap-1">
                      ...
                      {session.tool_call_count} tool call{session.tool_call_count === 1 ? '' : 's'}
                    </span>
                  )}
          ...
          {/* Compacted indicator */}
          {session?.compacted && (
            <div className="flex items-center gap-1.5 glass-subtle rounded-lg px-2.5 py-1.5 text-xs text-neon-amber">
