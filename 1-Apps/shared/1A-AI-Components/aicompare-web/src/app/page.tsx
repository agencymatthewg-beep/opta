  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
        <span className="text-xl font-bold text-moonlight">AI Comp</span>
    ...
    <div className="min-h-screen relative pb-20 md:pb-0">
      ...
      <section id="models" className="pt-24 pb-16 px-4">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-moonlight tracking-tight mb-6">
            AI Model Comparison
          </h1>
      ...
      <footer className="py-12 px-4 border-t border-glass-border">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-2xl font-bold text-moonlight mb-2">AI Comp</p>
