# Plan 15-02: Frame Rate Optimization

## Goal

Create ProMotion support, frame rate management, and GPU-efficient rendering utilities.

## Context

Building on PerformanceManager, this adds:
- ProMotion (120Hz) detection and optimization
- Frame rate targeting utilities
- GPU-efficient rendering patterns
- Animation frame budget management

## Implementation

### Step 1: Create Frame Rate Manager

Create `Opta Scan/Services/FrameRateManager.swift`:
...
Add:
- FrameRateManager.swift to Services group

## Files to Create/Modify

| File | Action |
|------|--------|
| `Opta Scan/Services/FrameRateManager.swift` | Create |
| `Opta Scan.xcodeproj/project.pbxproj` | Modify - add new file |

## Verification

1. Build succeeds
2. ProMotion detection works on Pro devices
3. Frame rate targeting adjusts display link
4. Animation duration scales with frame rate

## Dependencies

- Plan 15-01 complete (PerformanceManager)
- CADisplayLink
- UIScreen frameRate APIs
