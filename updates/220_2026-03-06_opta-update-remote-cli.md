...
- Steps: total=4, ok=2, skip=1, fail=1
...
| remote | cli | verify | fail | [192.168.188.11] missing command entries in remote opta --help: settings (remote CLI appears older than this workspace; update that host from latest source, then rerun opta update --target remote) |
