...
from opta_lmx.api.deps import SkillExecutorDep, SkillRegistryDep, verify_inference_key
...
router = APIRouter(tags=["skills"], dependencies=[Depends(verify_inference_key)])
