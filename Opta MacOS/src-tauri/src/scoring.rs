...
try:
    ...
    print(json.dumps({"score": 0, "unavailable": True}))
...
try:
    ...
    print(json.dumps({"totalGamesOptimized": 0, "averageScore": 0, "highestScore": 0, "highestScoreGame": "", "lastUpdated": 0}))
except Exception as e:
    print(json.dumps({"totalGamesOptimized": 0, "averageScore": 0, "highestScore": 0, "highestScoreGame": "", "lastUpdated": 0}))
"#;
...
try:
    ...
    print(json.dumps({"tier": "unknown", "description": "Hardware tier unavailable"}))
except Exception as e:
    print(json.dumps({"tier": "unknown", "description": str(e)}))
"#;
