...
1. `../1. personal/hardware.md` - Device ecosystem
2. `../1. personal/workflows.md` - Work patterns and preferences
3. `../1. personal/goals.md` - Current priorities
4. `../1. personal/profile.md` - Communication style
